...
<html>
<head>
  <title>Swift cart-login-Form</title>
    ...
    <div class="col-sm-5" style="margin-top:50px; float:left;left:100px;">
      <div class="panel panel-default text-center">
        <div class="panel-heading">
          <a href=""><h3 style="color: #fff;">Swift Cart </h3></a><br>
          <h4>Login Form</h4>
       ...
       <form action="<?php htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="form-horizontal" method="post">
          <fieldset>
            ...
            <div class="clearfix"></div><br>
              <input type="submit" name="login" value="Login" style="width: 90px;%;height: 50px;background:#000;border-radius:360px;" class="btn btn-primary">
            <br><br><br>
            <p>
