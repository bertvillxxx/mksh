...
<head>
  ...
  <title>Swift Cart Online shop-Men's</title>
  <meta charset="utf-8">
 ...
 <nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" id="font" href="../index2.php" >Swift Cart Online shop.com</a>
    </div>
 ...
 <div class="container-fluid" style="width:90%;">
  <div class="row">
    <div class="col-sm-11" style="max-width:98%;background-color:#e3e3e3;margin-left: 20%;">
      <div id="product-grid">
        <h4 style="color: #000;font-family: cominc suns ms,sarif;font-weight: bolder;">Products For Men's</h4>
  <?php
  ...
  ?>
    <div class="product-item" style="background:#fff;">
      ...
      <div class="product-price"><?php echo $product_array[$key]["price"]. "Php"; ?></div>
      </form>
    </div>
  <?php
      }
  ...
  ?>
  <div id="product-grid">
        <h3 style="color: #000;font-family: cominc suns ms,sarif;font-weight: bolder;">Products Of Accessesories</h3>
  <?php
