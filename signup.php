...
<html>
<head>
	<title>Swift Cart-Registration-Form</title>
    ...
    <div class="col-sm-5" style="float:left;margin-top:0px; margin-left: 100px;">
      <div class="panel panel-default text-center">
        <div class="panel-heading">
          <a href="../index.php"><h3 style="color: #fff;">Swift Cart</h3></a>
       ...
       <label><input type="checkbox" value="" checked >By Clicking Register You Are Agree To All <a href="terms.text" style="text-decoration: underline;">Terms & Conditions</a></label><br><br>
               ...
               <div class="form-group">
                ...
                <label><a href="index.php" style="color: red; text-decoration: underline;">Already have an account Login</a></label>
          </form>
        </div>
      </div>
    </div>
