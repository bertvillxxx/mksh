...
<nav class="navbar navbar-default navbar-fixed-top" style="background:#000;">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" id="font" href="../index2.php" >Swift Cart</a>
    </div>
     </div>
...
<span class="label label-danger" style="margin-left:300px;font-size:20px;">Your Total Price Is: <span id="total_price"><?php echo  number_format($total_price,2). "Php"; ?></span></span>
...
<a href="#" class="btn btn-primary" style="border-radius:5px;width:180px;">Go To Payment</a>
</div> 
</div>
    </div>
  </div>
